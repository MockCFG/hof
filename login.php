...
$fnameErr= $lnameErr = $emailErr = $genderErr = $phErr=$passErr="";
$firstname=$lastname = $email = $gender = $phno = $password="";
...
$sql = "INSERT INTO users (name,gender,email,)VALUES('$nameval','$genderval','$emailval')";
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="email" type="text" class="form-control" name="email" value="<?php echo $firstname;?>" placeholder="email">                                        
                                    </div>
